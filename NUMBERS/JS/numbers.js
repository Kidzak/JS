...
// exercise 4
//the loop will never end because i will never become exactly equal to 10.
//Instead, the value of

// i will continually increase, but due to a precision problem with floating-
// point arithmetic,
...
console.log(`Random number between ${minValue} and ${maxValue}:,
randomNumber`);
// exercise 6
